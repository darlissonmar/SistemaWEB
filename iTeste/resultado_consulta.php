			...
			<div id="body">
				...
				<div id="info">	
						<form id="cada-user" name="cadastro_usuario" method="post" action="">
							<fieldset style="height: 340px; color: #000;">
								<legend>Dados Pessoais</legend>
								<div id="consulta-nome">Nome:<?php echo "<b><font color='#FF0000'>".$dados['tb_user_pnome']."</font></b>";?> </div>
								<div id="consulta-tipo">Tipo de Usuário:<?php echo "<b><font color='#FF0000'>".$dados['tb_user_tipo']."</font></b>";?></div>
								...
								<div id="consulta-sexo">Sexo: <?php echo "<b><font color='#FF0000'>".$dados['tb_user_sexo']."</font></b>";?> </div>
								...
								<div id="consulta-cidade">Cidade:<?php echo "<b><font color='#FF0000'>".$dados['tb_user_end_cidade']."</font></b>";?></div>
								<div id="consulta-dt-nasc">Data de nascimento: <?php echo "<b><font color='#FF0000'>".$dados['tb_user_data_nasc']."</font></b>";?></div>
				    ...
				    <legend>Dados de Acesso</legend>
								    <p>Login: <?php echo "<b><font color='#FF0000'>".$dados['tb_user_login']."</font></b>";?></p>
								</fieldset>
